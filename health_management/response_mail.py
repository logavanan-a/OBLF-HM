...
def survey_responses():
    ...
    py_c = patients.filter(server_created_on__date=today)
    py_m = patients.filter(server_modified_on__date=today).exclude(id__in=py_c.values_list('id', flat=True), server_created_on__in=py_c.values_list('server_created_on', flat=True))
