        ...
        for cdw in clinic_data_two:   
            ...
            try:
                ...
                if not health_details:
                    ...
                    hts = Health.objects.create(uuid=uuid_id, user_uuid=user_uuid, 
                    patient_uuid=patient_uuid, is_alcoholic=clc_vlu.alcohol or 0, is_tobacco=clc_vlu.tobacco or 0, is_smoker=clc_vlu.smoking or 0,
                    dm_check=2,ht_check=2,dm_status=clc_vlu.diagnosis_dm or 0, ht_status=clc_vlu.diagnosis_ht or 0, dm_source_treatment=clc_vlu.sot_dm or 0, 
                    ht_source_treatment=clc_vlu.sot_ht  or 0,hyper_diabetic=clc_vlu.family_history or 0,
                    ht_years=ht_date,dm_years=dm_date, co_morbid_names = clc_vlu.co_morbidities or None,
                    dm_detected_by=clc_vlu.detected_by_dm or 0,ht_detected_by=clc_vlu.detected_by_ht or 0)
                    hts.server_created_on = clc_vlu.visit_date
                    hts.save()
                else:
