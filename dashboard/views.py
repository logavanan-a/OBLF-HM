...
def dashboard(request):
    ...
    a as (select distinct on ((trmt.visit_date at time zone 'Asia/Kolkata')::date, pt.village_id) (trmt.visit_date at time zone 'Asia/Kolkata')::date as vst_date, pt.village_id as vlg_id from health_management_treatments trmt 
